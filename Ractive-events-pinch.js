...
(function ( global, factory ) {
  ...
  // browser global
    ...
    throw new Error( 'Could not find Ractive! It must be loaded before the pinch plugin' );
  }
  ...
  var pinch = function ( node, fire ) {

    Hammer(node).on("pinch", function(event) {
      fire({
        node: node,
